  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          <h2 className="font-display text-lg text-foreground">1. Qué datos recolectamos</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg text-foreground">2. Para qué los usamos</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg text-foreground">3. Con quién los compartimos</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg text-foreground">4. Tus derechos (ARCO)</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg text-foreground">5. Cookies y almacenamiento local</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg text-foreground">6. Seguridad</h2>
          <p className="mt-2">

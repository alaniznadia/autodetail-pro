...
export default function ReturnsPolicyPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <h1 className="font-display text-[28px] font-bold">Cambios y devoluciones</h1>
      ...
      <div className="mt-8 flex flex-col gap-6 text-[18px] leading-relaxed text-foreground/90">
        ...
        <section>
          <h2 className="font-display text-[22px] text-foreground">Cómo pedir un cambio o devolución</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-[22px] text-foreground">Producto con fallas o defectuoso</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-[22px] text-foreground">Costos de envío en la devolución</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-[22px] text-foreground">Reintegro</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-[22px] text-foreground">Compras en el local</h2>
          <p className="mt-2">
